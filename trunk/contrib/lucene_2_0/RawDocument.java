 ...
 * 0 = default, kein Dokumenttype zugeordnet
 * 1 = HTML-document `Christian Horn
 */
  ...
  /**
   * Autor: Christian Horn
   * @return true, if HTML-Document
   */
  
  public boolean isHTMLDoc()
  {
	  return (this.mDocType==1);
  }
