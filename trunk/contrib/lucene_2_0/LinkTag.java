...
public class LinkTag extends AbstractHitTag {
    ...
    throws RegainException
  {
    ...
    if (url.startsWith("file://") && useFileToHttpBridge) {
      ...
      // paro: Prepare german umlauts...
      href = RegainToolkit.replace(href, "ü", "Ã¼");
      href = RegainToolkit.replace(href, "Ü", "Ãœ");
      href = RegainToolkit.replace(href, "ä", "Ã¤");
      href = RegainToolkit.replace(href, "Ä", "Ã„");
      href = RegainToolkit.replace(href, "ö", "Ã¶");
      href = RegainToolkit.replace(href, "Ö", "Ã–");
      href = RegainToolkit.replace(href, "ß", "ÃŸ");
