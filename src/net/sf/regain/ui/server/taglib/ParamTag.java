...
/**
 * Taglib wrapper for the shared param tag.
 *
 * @see net.sf.regain.search.sharedlib.ParamTag
 *
 * @author Til Schneider, www.murfman.de
 */
public class ParamTag extends SharedTagWrapperTag {

  /**
   * Creates a new instance of ParamTag.
   */
  public ParamTag() {
    super(new net.sf.regain.search.sharedlib.ParamTag());
  }
