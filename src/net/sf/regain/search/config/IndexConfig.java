...
public class IndexConfig {
	...
	protected static final String[] DEFAULT_SEARCH_FIELD_LIST = { "content", "title", "headlines" };
	...
	/**
	 * The regular expression that identifies URLs that should be opened in a
	 * new window.
	 */
	 ...
	 * "field:"-operator. Read the <a
	 * href="http://jakarta.apache.org/lucene/docs/queryparsersyntax.html">lucene
	 * query syntax</a> for details.
	 */
	 ...
	 * @param directory
	 *            The directory where the index is located.
	 * @param openInNewWindowRegex
	 *            The regular expression that identifies URLs that should be
	 *            opened in a new window.
	 * @param useFileToHttpBridge
	 *            Whether the file-to-http-bridge should be used. See
	 *            {@link #getUseFileToHttpBridge()} for details.
	 * @param searchFieldList
	 *            The index fields to search by default.
	 * @param rewriteRules
	 *            The URL rewrite rules. Contains pairs of URL prefixes: The
	 *            first prefix will be replaced by the second.
	 * @param searchAccessControllerClass
	 *            The class name of the {@link SearchAccessController} to use.
	 * @param searchAccessControllerJar
	 *            The name of jar file to load the
	 *            {@link SearchAccessController} from.
	 * @param searchAccessControllerConfig
	 *            The configuration for the {@link SearchAccessController}.
	 * @throws RegainException
	 *             If loading the SearchAccessController failed.
	 */
	public IndexConfig(String name, String directory, String openInNewWindowRegex, boolean useFileToHttpBridge,
			String[] searchFieldList, String[][] rewriteRules, String searchAccessControllerClass,
			String searchAccessControllerJar, Properties searchAccessControllerConfig) throws RegainException {
		mName = name;
		...
		if (searchAccessControllerClass != null) {
			mSearchAccessController = (SearchAccessController) RegainToolkit.createClassInstance(
					searchAccessControllerClass, SearchAccessController.class, searchAccessControllerJar);
	 ...
	 * results, regain offers the file-to-http-bridge that provides all files
	 * that are listed in the index via http.
	 * 
	 ...
	 * <p>
	 * The returned array contains pairs of URL prefixes: The first prefix will
