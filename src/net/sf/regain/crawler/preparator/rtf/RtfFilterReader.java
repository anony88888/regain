...
public class RtfFilterReader extends FilterReader {
   ...
   * Leerzeichen einzuf�gen, wenn die Schachtelungstiefe verlassen wurde.
  ...
  /**
   * Gibt an, ob die {@link #mark(int)}-Methode unterst�tzt wird.
   * <p>
   * Dieser Reader unterst�tzt das nicht.
   *
   ...
   * @return Die Anzahl Zeichen, die tats�chlich geschrieben wurde oder
