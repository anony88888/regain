...
public class UrlPattern {
   ...
   *
   * @param regexPattern Der Regul�re Ausdruck, die eine URL findet.
   * @param regexUrlGroup Die Gruppe des Regul�ren Ausdrucks, die die URL
   *        enthält.
   ...
   *
   * @return Der Regul�re Ausdruck, die eine URL findet.
   */
   ...
   *
   * @return Die Gruppe des Regul�ren Ausdrucks, die die URL enthält.
   */
